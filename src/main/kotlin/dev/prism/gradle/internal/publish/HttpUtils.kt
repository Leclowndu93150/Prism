...
// Vendored into Prism with minimal adaptation.
...
class HttpUtils(
    val exceptionFactory: HttpExceptionFactory = DefaultHttpExceptionFactory(),
    ...
    val userAgent = "prism/dev.prism.gradle"
    ...
    class HttpException(val response: HttpResponse<String>, message: String) :
        IOException("Request failed, status: ${response.statusCode()} message: $message url: ${response.uri()}")
}
